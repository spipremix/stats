...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'archiver_concatener_par_an' => 'I dati di visita di più di @nb@ anni saranno aggiunti e processati, per ogni articolo, il primo giorno di ogni anno.', # RELIRE
	'archiver_concatener_par_mois' => 'I dati di visita di più di @nb@ anni saranno aggiunti e processati, per ogni articolo, il primo giorno di ogni mese.', # RELIRE
