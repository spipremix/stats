...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'archiver_nettoyer_explications' => 'Удалить строки ссылок или визитов на элементы, которые (больше) не существуют в базе данных.', # MODIF
	'archiver_nettoyer_referers_articles' => 'Очистить ссылки на статьи', # MODIF
	'archiver_nettoyer_visites_articles' => 'Очистить посещения статей', # MODIF
